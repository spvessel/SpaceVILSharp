...
public class PasswordLine extends HorizontalStack {
    ...
    public PasswordLine() {
        ...
        setStyle(com.spacevil.Common.DefaultsService.getDefaultStyle(PasswordLine.class));
    }
    ...
    public void setStyle(com.spacevil.Decorations.Style style) {
        ...
        com.spacevil.Decorations.Style inner_style = style.getInnerStyle("showmarker");
        if (inner_style != null) {
