...
import com.spacevil.Common.DefaultsService;
...
import com.spacevil.Flags.KeyCode;
import com.spacevil.Flags.KeyMods;
...
public class TextEdit extends Prototype
    ...
    private com.spacevil.Rectangle _cursor;
    private int _cursor_position = 0;
    private com.spacevil.Rectangle _selectedArea;
     ...
     */
    public com.spacevil.Rectangle getSelectionArea() {
    ...
    public TextEdit() {
        ...
        _cursor = new com.spacevil.Rectangle();
        _selectedArea = new com.spacevil.Rectangle();
