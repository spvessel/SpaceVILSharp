...
import com.spacevil.Core.InterfaceVLayout;
...
public class VerticalStack extends Prototype implements InterfaceVLayout {
    ...
    public VerticalStack() {
        ...
        setStyle(com.spacevil.Common.DefaultsService.getDefaultStyle(VerticalStack.class));
        isFocusable = false;
    }
    ...
    public void updateLayout() {
        ...
        for (InterfaceBaseItem child : getItems()) {
            if (child.isVisible()) {
                if (child.getHeightPolicy() == com.spacevil.Flags.SizePolicy.FIXED) {
                    fixed_count++;
        ...
        for (InterfaceBaseItem child : getItems()) {
            if (child.isVisible()) {
                ...
                if (child.getHeightPolicy() == com.spacevil.Flags.SizePolicy.EXPAND) {
