...
public class MainWindow extends ActiveWindow {
    ...
    public void initWindow() {
        ...
        Font font = com.spacevil.Common.DefaultsService.getDefaultFont(Font.PLAIN, 16);
        ...
        btn_layout.setSizePolicy(com.spacevil.Flags.SizePolicy.EXPAND, com.spacevil.Flags.SizePolicy.EXPAND);
        btn_layout.setBorderRadius(new CornerRadius(6));
        com.spacevil.Decorations.ItemState state = new com.spacevil.Decorations.ItemState(new Color(255, 255, 255, 80));
        ...
        btn_layout.addItemState(com.spacevil.Flags.ItemStateType.HOVERED, state);
        ...
        btn_settings.setSizePolicy(com.spacevil.Flags.SizePolicy.EXPAND, com.spacevil.Flags.SizePolicy.EXPAND);
        ...
        btn_label.setSizePolicy(com.spacevil.Flags.SizePolicy.EXPAND, com.spacevil.Flags.SizePolicy.EXPAND);
        ...
        btn_flow.setSizePolicy(com.spacevil.Flags.SizePolicy.EXPAND, com.spacevil.Flags.SizePolicy.EXPAND);
        ...
        btn_complex.setSizePolicy(com.spacevil.Flags.SizePolicy.EXPAND, com.spacevil.Flags.SizePolicy.EXPAND);
        ...
        btn_image.setSizePolicy(com.spacevil.Flags.SizePolicy.EXPAND, com.spacevil.Flags.SizePolicy.EXPAND);
        ...
        btn_input.setSizePolicy(com.spacevil.Flags.SizePolicy.EXPAND, com.spacevil.Flags.SizePolicy.EXPAND);
