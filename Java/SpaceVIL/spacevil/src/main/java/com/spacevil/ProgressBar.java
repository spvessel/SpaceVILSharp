...
public class ProgressBar extends Prototype {
    ...
    public ProgressBar() {
        ...
        setStyle(com.spacevil.Common.DefaultsService.getDefaultStyle(ProgressBar.class));
        isFocusable = false;
    }
...
//    }
    ...
    public void setStyle(com.spacevil.Decorations.Style style) {
        ...
        com.spacevil.Decorations.Style inner_style = style.getInnerStyle("progressbar");
        if (inner_style != null) {
