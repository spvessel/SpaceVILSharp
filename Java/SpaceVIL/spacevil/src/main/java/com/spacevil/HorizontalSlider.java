...
public class HorizontalSlider extends Prototype {
    ...
    public HorizontalSlider() {
        ...
        handler.direction = com.spacevil.Flags.Orientation.HORIZONTAL;

        // setStyle(DefaultsService.getDefaultStyle("SpaceVIL.HorizontalSlider"));
        setStyle(com.spacevil.Common.DefaultsService.getDefaultStyle(HorizontalSlider.class));
    }
    ...
    public void setStyle(com.spacevil.Decorations.Style style) {
        ...
        com.spacevil.Decorations.Style inner_style = style.getInnerStyle("track");
        if (inner_style != null) {
