...
public class ImageTest extends ActiveWindow {
    ...
    public void initWindow() {
        ...
        h_stack.setSizePolicy(com.spacevil.Flags.SizePolicy.EXPAND, com.spacevil.Flags.SizePolicy.FIXED);
        h_stack.setBackground(255, 255, 255, 10);
        h_stack.setHeight(30);
        h_stack.setAlignment(com.spacevil.Flags.ItemAlignment.TOP, com.spacevil.Flags.ItemAlignment.LEFT);
        ...
        r1.setSizePolicy(com.spacevil.Flags.SizePolicy.EXPAND, com.spacevil.Flags.SizePolicy.EXPAND);
        h_stack.addItem(r1);
        for (int i = 0; i < 4; i++) {
            Rectangle rect = new Rectangle();
            rect.setBackground(255, 255, 0);
            rect.setSize(30, 30);
            rect.setSizePolicy(com.spacevil.Flags.SizePolicy.FIXED, com.spacevil.Flags.SizePolicy.EXPAND);
            h_stack.addItem(rect);
        }

        ProgressBar pb = new ProgressBar();
        pb.setAlignment(com.spacevil.Flags.ItemAlignment.TOP, com.spacevil.Flags.ItemAlignment.LEFT);
        ...
        btn_action.setWidthPolicy(com.spacevil.Flags.SizePolicy.EXPAND);
        btn_action.setHeightPolicy(com.spacevil.Flags.SizePolicy.FIXED);
        btn_action.setAlignment(com.spacevil.Flags.ItemAlignment.HCENTER, com.spacevil.Flags.ItemAlignment.TOP);
        btn_action.setMargin(new com.spacevil.Decorations.Indents(30, 0, 30, 0));
        btn_action.setBorderRadius(10);
        btn_action.setTextMargin(new com.spacevil.Decorations.Indents(0, 45, 0, 0));
        ...
        img.setSize(256, 134);
        img.setSizePolicy(com.spacevil.Flags.SizePolicy.FIXED, com.spacevil.Flags.SizePolicy.FIXED);
        img.setAlignment(com.spacevil.Flags.ItemAlignment.VCENTER, com.spacevil.Flags.ItemAlignment.HCENTER);
        ...
        combo.setAlignment(com.spacevil.Flags.ItemAlignment.VCENTER, com.spacevil.Flags.ItemAlignment.LEFT);
