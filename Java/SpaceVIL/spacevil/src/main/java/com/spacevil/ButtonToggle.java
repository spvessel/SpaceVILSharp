...
public class ButtonToggle extends Prototype {
    ...
    public ButtonToggle() {
        ...
        setStyle(com.spacevil.Common.DefaultsService.getDefaultStyle(ButtonToggle.class));
    }
    ...
    public void setToggled(boolean value) {
        _toggled = value;
        if (value == true)
            setState(com.spacevil.Flags.ItemStateType.TOGGLED);
        else
            setState(com.spacevil.Flags.ItemStateType.BASE);
    }

    void onKeyPress(InterfaceItem sender, KeyArgs args) {
        if (args.key == com.spacevil.Flags.KeyCode.ENTER && eventMouseClick != null) {
