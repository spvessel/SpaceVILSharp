...
public class LayoutsTest extends ActiveWindow {
    ...
    public void initWindow() {
        ...
        btn_bar.setAlignment(com.spacevil.Flags.ItemAlignment.HCENTER, com.spacevil.Flags.ItemAlignment.VCENTER);
        btn_bar.setItemName("ButtonBar");
        btn_bar.setWidthPolicy(com.spacevil.Flags.SizePolicy.EXPAND);
        btn_bar.setHeightPolicy(com.spacevil.Flags.SizePolicy.EXPAND);
        ...
        frame.setHeightPolicy(com.spacevil.Flags.SizePolicy.FIXED);
        ...
        listbox_left_1.setAlignment(com.spacevil.Flags.ItemAlignment.HCENTER, com.spacevil.Flags.ItemAlignment.VCENTER);
        ...
        listbox_left_2.setAlignment(com.spacevil.Flags.ItemAlignment.HCENTER, com.spacevil.Flags.ItemAlignment.VCENTER);
        grid.insertItem(listbox_left_2, 1, 0);

        ListBox listbox_right_1 = new ListBox();
        listbox_right_1.setAlignment(com.spacevil.Flags.ItemAlignment.HCENTER, com.spacevil.Flags.ItemAlignment.VCENTER);
        grid.insertItem(listbox_right_1, 0, 1);
        ListBox listbox_right_2 = new ListBox();
        listbox_right_2.setAlignment(com.spacevil.Flags.ItemAlignment.HCENTER, com.spacevil.Flags.ItemAlignment.VCENTER);
        ...
        InterfaceMouseMethodState left_click = (sender, args) -> {
            ...
            contact_1.setAlignment(com.spacevil.Flags.ItemAlignment.TOP, com.spacevil.Flags.ItemAlignment.LEFT);
            VisualContact contact_2 = new VisualContact();
            contact_2.setAlignment(com.spacevil.Flags.ItemAlignment.TOP, com.spacevil.Flags.ItemAlignment.LEFT);
