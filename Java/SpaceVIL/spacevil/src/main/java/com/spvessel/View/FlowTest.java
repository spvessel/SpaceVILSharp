...
public class FlowTest extends ActiveWindow {
    ...
    public void initWindow() {
        ...
        com.spvessel.MenuItem restore = new com.spvessel.MenuItem("Restore");
        // restore.eventMouseClick += (sender, args) ->
        // {
        // flow.setHScrollOffset(0);
        // flow.setVScrollOffset(0);
        // };
        com.spvessel.MenuItem x_plus = new com.spvessel.MenuItem("X += 100");
        // x_plus.eventMouseClick += (sender, args) ->
        // {
        // flow.setHScrollOffset(flow.getHScrollOffset() + 10);
        // };
        com.spvessel.MenuItem y_plus = new com.spvessel.MenuItem("Y += 100");
        ...
        com.spvessel.MenuItem x_minus = new com.spvessel.MenuItem("X -= 100");
        // x_minus.eventMouseClick += (sender, args) ->
        // {
        // flow.setHScrollOffset(flow.getHScrollOffset() - 10);
        // };
        com.spvessel.MenuItem y_minus = new com.spvessel.MenuItem("Y -= 100");
