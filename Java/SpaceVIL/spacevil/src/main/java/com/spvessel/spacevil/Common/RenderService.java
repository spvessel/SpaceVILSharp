 ...
 * <p> Tip: RenderService is usualy used with com.spvessel.spacevil.Core.InterfaceOpenGLLayer.
 */
public final class RenderService {
     ...
     * @param window A window as com.spvessel.spacevil.CoreWindow.
     * @param layer An item that etends Prototype and implements com.spvessel.spacevil.Core.InterfaceOpenGLLayer.
     */
