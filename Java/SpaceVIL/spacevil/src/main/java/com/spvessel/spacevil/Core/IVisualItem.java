 ...
 * Not implemented!!!
 */
public interface IVisualItem extends IBaseItem {
    ...
    public void addEventListener(GeometryEventType type, IBaseItem listener);

    public void removeEventListener(GeometryEventType type, IBaseItem listener);
