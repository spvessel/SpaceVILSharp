 ...
 */
public class TextEdit extends Prototype { // implements InterfaceTextEditable, InterfaceTextShortcuts,
                                          // InterfaceDraggable {
    static int count = 0;
    ...
    public TextEdit() {
        ...
        //
        // ShiftValCodes = new LinkedList<>(Arrays.asList(KeyCode.LEFT, KeyCode.RIGHT,
        // KeyCode.END, KeyCode.HOME));
        // InsteadKeyMods = new LinkedList<>(Arrays.asList(KeyCode.LEFTSHIFT,
        // KeyCode.RIGHTSHIFT, KeyCode.LEFTCONTROL,
        // KeyCode.RIGHTCONTROL, KeyCode.LEFTALT, KeyCode.RIGHTALT, KeyCode.LEFTSUPER,
        // KeyCode.RIGHTSUPER));
    ...
    // int w = getTextWidth();
    // if (_text_object.getTextAlignment().contains(ItemAlignment.RIGHT) && (w <
    // _cursorXMax)) {
    ...
    // // replaceCursor();
    // }
    // if (args.key == KeyCode.DELETE && _cursor_position < privGetText().length())
    // // delete
    // {
    // StringBuilder sb = new StringBuilder(privGetText());
    // privSetText(sb.deleteCharAt(_cursor_position).toString());
    ...
    // }
    // }
    // if (args.key == KeyCode.RIGHT && _cursor_position < privGetText().length())
    // // arrow right
    // {
    // if (!_justSelected) {
    // _cursor_position++;
    ...
    // if ((getTextWidth() >= _cursorXMax) ||
    // !_text_object.getTextAlignment().contains(ItemAlignment.RIGHT)) {
    ...
    // if (_text_object.getTextAlignment().contains(ItemAlignment.RIGHT) && (w <
    // _cursorXMax)) {
    // int xcp = getX() + getWidth() - w + pos - getPadding().right // -
    // _cursor.getWidth()
    ...
    public void setFont(Font font) {
        ...
        // GraphicsMathService.changeFontFamily(font.getFamily(),
        // _substrate_text.getFont())); //new Font(font.getFamily(),
        // _substrate_text.getFont().getStyle(), _substrate_text.getFont().getSize()));
    ...
    // }
    // String text = privGetText();
    // String newText = text.substring(0, _cursor_position) + pasteStr +
    // text.substring(_cursor_position);
    ...
    // redoQueue.pollLast();
    // }
    // redoQueue.addFirst(new TextEditState(tmpText.textState,
    // tmpText.cursorState));
    //
