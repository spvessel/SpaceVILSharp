...
public class MainWindow extends ActiveWindow {
    ...
    public void initWindow() {
        ...
        Font font = DefaultsService.getDefaultFont(Font.ITALIC, 18);
        ...
        InterfaceMouseMethodState layout_click =
                (sender, args) -> WindowLayoutBox.tryShow("LayoutsTest");
        ...
        InterfaceMouseMethodState settings_click =
                (sender, args) -> WindowLayoutBox.tryShow("SettingsTest");
        ...
        InterfaceMouseMethodState flow_click =
                (sender, args) -> WindowLayoutBox.tryShow("FlowTest");
        ...
        InterfaceMouseMethodState complex_click =
                (sender, args) -> WindowLayoutBox.tryShow("ComplexTest");
        ...
        InterfaceMouseMethodState img_click =
                (sender, args) -> WindowLayoutBox.tryShow("ImageTest");
        ...
        grid.addItems(btn_layout, btn_settings, btn_label, btn_flow, btn_input, btn_image,
                btn_complex);
    }
}
