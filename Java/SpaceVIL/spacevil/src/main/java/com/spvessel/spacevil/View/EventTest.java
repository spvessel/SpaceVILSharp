...
public class EventTest extends ActiveWindow {
    ...
    private BlankItem getBlankItem(String name) {
        ...
        blank.eventMousePress.add((sender, args) -> {
            System.out.println(blank.getItemName() + " EventMousePress");
        });
    ...
    public void initWindow() {
        ...
        b3.setFocus();
        b3.setPassEvents(true);

        for (InputEventType i : b3.getBlockedEvents()) {
