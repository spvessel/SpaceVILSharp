...
public class FlowTest extends ActiveWindow {
    ...
    public void initWindow() {
        ...
        // // create items
        // IBaseItem cRed = getCircle(_diameter, new Color(255, 94, 94));
        // cRed.setItemName("cRed");
        // IBaseItem cGreen = getCircle(_diameter, new Color(16, 180, 111));
        // cGreen.setItemName("cGreen");
        // IBaseItem cBlue = getCircle(_diameter, new Color(10, 162, 232));
    ...
    public static void setCircleAlignment(IBaseItem circle, ItemAlignment... alignment) {
    ...
    public static SubtractFigure getCircleEffect(IBaseItem circle, IBaseItem subtract) {
