...
public class Containers extends ActiveWindow {
    ...
    public void initWindow() {
        ...
        BufferedImage iBig = DefaultsService.getDefaultImage(EmbeddedImage.Gear, EmbeddedImageSize.Size64x64);
        BufferedImage iSmall = DefaultsService.getDefaultImage(EmbeddedImage.Gear, EmbeddedImageSize.Size32x32);
        setIcon(iBig, iSmall);
        ...
        eventKeyPress.add((sender, args) -> {
            ...
            if (args.key == KeyCode.Enter) {
                ...
                // t.setEditable(false);
                t.setVScrollBarPolicy(VisibilityPolicy.AsNeeded);
                t.setHScrollBarPolicy(VisibilityPolicy.AsNeeded);
                t.disableMenu(true);
