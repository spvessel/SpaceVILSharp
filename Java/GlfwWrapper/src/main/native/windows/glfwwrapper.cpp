...
JNIEXPORT jint JNICALL Java_com_spvessel_glfwwrapper_GlfwWrapper_Init(JNIEnv *env, jobject sender)
{
    return glfwInit();
}

JNIEXPORT void JNICALL Java_com_spvessel_glfwwrapper_GlfwWrapper_Terminate(JNIEnv *env, jobject sender)
{
    glfwTerminate();
}

JNIEXPORT void JNICALL Java_com_spvessel_glfwwrapper_GlfwWrapper_SwapInterval(JNIEnv *env, jobject sender, jint interval)
{
    glfwSwapInterval(interval);
}

JNIEXPORT void JNICALL Java_com_spvessel_glfwwrapper_GlfwWrapper_SwapBuffers(JNIEnv *env, jobject sender, jlong window)
{
    glfwSwapBuffers((GLFWwindow *)window);
}

JNIEXPORT jstring JNICALL Java_com_spvessel_glfwwrapper_GlfwWrapper_GetClipboardString(JNIEnv *env, jobject sender, jlong window)
{
...
JNIEXPORT void JNICALL Java_com_spvessel_glfwwrapper_GlfwWrapper_SetClipboardString(JNIEnv *env, jobject sender, jlong window, jstring string)
{
...
JNIEXPORT void JNICALL Java_com_spvessel_glfwwrapper_GlfwWrapper_WaitEventsTimeout(JNIEnv *env, jobject sender, jdouble timeout)
{
    glfwWaitEventsTimeout(timeout);
}

JNIEXPORT void JNICALL Java_com_spvessel_glfwwrapper_GlfwWrapper_WaitEvents(JNIEnv *env, jobject sender)
{
    glfwWaitEvents();
}

JNIEXPORT void JNICALL Java_com_spvessel_glfwwrapper_GlfwWrapper_PollEvents(JNIEnv *env, jobject sender)
{
    glfwPollEvents();
}
...
JNIEXPORT void JNICALL Java_com_spvessel_glfwwrapper_GlfwWrapper_SetCursorPosCallback(JNIEnv *env, jobject sender, jlong window, jobject callback)
{
    if (jvm == NULL)
    {
        env->GetJavaVM(&jvm);
...
JNIEXPORT void JNICALL Java_com_spvessel_glfwwrapper_GlfwWrapper_SetMouseButtonCallback(JNIEnv *env, jobject sender, jlong window, jobject callback)
{
    if (jvm == NULL)
    {
        env->GetJavaVM(&jvm);
...
JNIEXPORT void JNICALL Java_com_spvessel_glfwwrapper_GlfwWrapper_SetScrollCallback(JNIEnv *env, jobject sender, jlong window, jobject callback)
{
    if (jvm == NULL)
    {
        env->GetJavaVM(&jvm);
...
JNIEXPORT void JNICALL Java_com_spvessel_glfwwrapper_GlfwWrapper_SetKeyCallback(JNIEnv *env, jobject sender, jlong window, jobject callback)
{
    if (jvm == NULL)
    {
        env->GetJavaVM(&jvm);
...
JNIEXPORT void JNICALL Java_com_spvessel_glfwwrapper_GlfwWrapper_SetCharModsCallback(JNIEnv *env, jobject sender, jlong window, jobject callback)
{
    if (jvm == NULL)
    {
        env->GetJavaVM(&jvm);
...
JNIEXPORT void JNICALL Java_com_spvessel_glfwwrapper_GlfwWrapper_SetWindowCloseCallback(JNIEnv *env, jobject sender, jlong window, jobject callback)
{
    if (jvm == NULL)
    {
        env->GetJavaVM(&jvm);
...
JNIEXPORT void JNICALL Java_com_spvessel_glfwwrapper_GlfwWrapper_SetWindowPosCallback(JNIEnv *env, jobject sender, jlong window, jobject callback)
{
    if (jvm == NULL)
    {
        env->GetJavaVM(&jvm);
...
JNIEXPORT void JNICALL Java_com_spvessel_glfwwrapper_GlfwWrapper_SetWindowFocusCallback(JNIEnv *env, jobject sender, jlong window, jobject callback)
{
    if (jvm == NULL)
    {
        env->GetJavaVM(&jvm);
...
JNIEXPORT void JNICALL Java_com_spvessel_glfwwrapper_GlfwWrapper_SetWindowSizeCallback(JNIEnv *env, jobject sender, jlong window, jobject callback)
{
    if (jvm == NULL)
    {
        env->GetJavaVM(&jvm);
...
JNIEXPORT void JNICALL Java_com_spvessel_glfwwrapper_GlfwWrapper_SetWindowIconifyCallback(JNIEnv *env, jobject sender, jlong window, jobject callback)
{
    if (jvm == NULL)
    {
        env->GetJavaVM(&jvm);
...
JNIEXPORT void JNICALL Java_com_spvessel_glfwwrapper_GlfwWrapper_SetWindowRefreshCallback(JNIEnv *env, jobject sender, jlong window, jobject callback)
{
    if (jvm == NULL)
    {
        env->GetJavaVM(&jvm);
...
JNIEXPORT void JNICALL Java_com_spvessel_glfwwrapper_GlfwWrapper_SetFramebufferSizeCallback(JNIEnv *env, jobject sender, jlong window, jobject callback)
{
    if (jvm == NULL)
    {
        env->GetJavaVM(&jvm);
...
JNIEXPORT void JNICALL Java_com_spvessel_glfwwrapper_GlfwWrapper_SetWindowContentScaleCallback(JNIEnv *env, jobject sender, jlong window, jobject callback)
{
    if (jvm == NULL)
    {
        env->GetJavaVM(&jvm);
...
JNIEXPORT void JNICALL Java_com_spvessel_glfwwrapper_GlfwWrapper_SetDropCallback(JNIEnv *env, jobject sender, jlong window, jobject callback)
{
    if (jvm == NULL)
    {
        env->GetJavaVM(&jvm);
...
JNIEXPORT void JNICALL Java_com_spvessel_glfwwrapper_GlfwWrapper_WindowHint(JNIEnv *env, jobject sender, jint hint, jint value)
{
    glfwWindowHint(hint, value);
}

JNIEXPORT jlong JNICALL Java_com_spvessel_glfwwrapper_GlfwWrapper_CreateWindow(JNIEnv *env, jobject sender, jint width, jint height, jstring title, jlong monitor, jlong share)
{
...
JNIEXPORT void JNICALL Java_com_spvessel_glfwwrapper_GlfwWrapper_SetWindowShouldClose(JNIEnv *env, jobject sender, jlong window, jint value)
{
    glfwSetWindowShouldClose((GLFWwindow *)window, value);
}

JNIEXPORT jboolean JNICALL Java_com_spvessel_glfwwrapper_GlfwWrapper_WindowShouldClose(JNIEnv *env, jobject sender, jlong window)
{
    int result = glfwWindowShouldClose((GLFWwindow *)window);
    return (result == 1) ? true : false;
}

JNIEXPORT void JNICALL Java_com_spvessel_glfwwrapper_GlfwWrapper_MakeContextCurrent(JNIEnv *env, jobject sender, jlong window)
{
    glfwMakeContextCurrent((GLFWwindow *)window);
}

JNIEXPORT void JNICALL Java_com_spvessel_glfwwrapper_GlfwWrapper_SetWindowPos(JNIEnv *env, jobject sender, jlong window, jint xpos, jint ypos)
{
    glfwSetWindowPos((GLFWwindow *)window, xpos, ypos);
}

JNIEXPORT jintArray JNICALL Java_com_spvessel_glfwwrapper_GlfwWrapper_GetWindowPos(JNIEnv *env, jobject sender, jlong window)
{
    int x, y;
...
JNIEXPORT void JNICALL Java_com_spvessel_glfwwrapper_GlfwWrapper_SetWindowSize(JNIEnv *env, jobject sender, jlong window, jint width, jint height)
{
    glfwSetWindowSize((GLFWwindow *)window, width, height);
}

JNIEXPORT jintArray JNICALL Java_com_spvessel_glfwwrapper_GlfwWrapper_GetWindowSize(JNIEnv *env, jobject sender, jlong window)
{
    int w, h;
...
JNIEXPORT void JNICALL Java_com_spvessel_glfwwrapper_GlfwWrapper_SetWindowSizeLimits(JNIEnv *env, jobject sender, jlong window, jint minWidth, jint minHeight, jint maxWidth, jint maxHeight)
{
    glfwSetWindowSizeLimits((GLFWwindow *)window, minWidth, minHeight, maxWidth, maxHeight);
}

JNIEXPORT void JNICALL Java_com_spvessel_glfwwrapper_GlfwWrapper_SetWindowAspectRatio(JNIEnv *env, jobject sender, jlong window, jint number, jint denom)
{
    glfwSetWindowAspectRatio((GLFWwindow *)window, number, denom);
}

JNIEXPORT void JNICALL Java_com_spvessel_glfwwrapper_GlfwWrapper_ShowWindow(JNIEnv *env, jobject sender, jlong window)
{
    glfwShowWindow((GLFWwindow *)window);
}

JNIEXPORT void JNICALL Java_com_spvessel_glfwwrapper_GlfwWrapper_HideWindow(JNIEnv *env, jobject sender, jlong window)
{
    glfwHideWindow((GLFWwindow *)window);
}

JNIEXPORT jfloatArray JNICALL Java_com_spvessel_glfwwrapper_GlfwWrapper_GetWindowContentScale(JNIEnv *env, jobject sender, jlong window)
{
    float xscale, yscale;
...
JNIEXPORT void JNICALL Java_com_spvessel_glfwwrapper_GlfwWrapper_MaximizeWindow(JNIEnv *env, jobject sender, jlong window)
{
    glfwMaximizeWindow((GLFWwindow *)window);
}

JNIEXPORT void JNICALL Java_com_spvessel_glfwwrapper_GlfwWrapper_RestoreWindow(JNIEnv *env, jobject sender, jlong window)
{
    glfwRestoreWindow((GLFWwindow *)window);
}

JNIEXPORT void JNICALL Java_com_spvessel_glfwwrapper_GlfwWrapper_FocusWindow(JNIEnv *env, jobject sender, jlong window)
{
    glfwFocusWindow((GLFWwindow *)window);
}

JNIEXPORT void JNICALL Java_com_spvessel_glfwwrapper_GlfwWrapper_IconifyWindow(JNIEnv *env, jobject sender, jlong window)
{
    glfwIconifyWindow((GLFWwindow *)window);
}

JNIEXPORT void JNICALL Java_com_spvessel_glfwwrapper_GlfwWrapper_DestroyWindow(JNIEnv *env, jobject sender, jlong window)
{
    glfwDestroyWindow((GLFWwindow *)window);
}

JNIEXPORT void JNICALL Java_com_spvessel_glfwwrapper_GlfwWrapper_SetWindowIcon(JNIEnv *env, jobject sender, jlong window, jint count, jobjectArray image)
{
...
JNIEXPORT jlong JNICALL Java_com_spvessel_glfwwrapper_GlfwWrapper_GetPrimaryMonitor(JNIEnv *env, jobject sender)
{
    GLFWmonitor *monitor = glfwGetPrimaryMonitor();
    return (jlong)monitor;
}

JNIEXPORT jintArray JNICALL Java_com_spvessel_glfwwrapper_GlfwWrapper_GetMonitorWorkarea(JNIEnv *env, jobject sender, jlong monitor)
{
    int x, y, w, h;
...
JNIEXPORT void JNICALL Java_com_spvessel_glfwwrapper_GlfwWrapper_SetWindowMonitor(JNIEnv *env, jobject sender, jlong window, jlong monitor, jint xpos, jint ypos, jint width, jint height, jint refreshRate)
{
    glfwSetWindowMonitor((GLFWwindow *)window, (GLFWmonitor *)monitor, xpos, ypos, width, height, refreshRate);
}

JNIEXPORT jintArray JNICALL Java_com_spvessel_glfwwrapper_GlfwWrapper_GetFramebufferSize(JNIEnv *env, jobject sender, jlong window)
{
    int w, h;
...
JNIEXPORT jobject JNICALL Java_com_spvessel_glfwwrapper_GlfwWrapper_GetVideoMode(JNIEnv *env, jobject sender, jlong monitor)
{
...
JNIEXPORT jfloatArray JNICALL Java_com_spvessel_glfwwrapper_GlfwWrapper_GetMonitorContentScale(JNIEnv *env, jobject sender, jlong monitor)
{
    float xscale, yscale;
...
JNIEXPORT jlong JNICALL Java_com_spvessel_glfwwrapper_GlfwWrapper_CreateStandardCursor(JNIEnv *env, jobject sender, jint shape)
{
    return (jlong)glfwCreateStandardCursor(shape);
}

JNIEXPORT jlong JNICALL Java_com_spvessel_glfwwrapper_GlfwWrapper_CreateCursor(JNIEnv *env, jobject sender, jobject image, jint xhot, jint yhot)
{
    GLFWimage img;
...
JNIEXPORT void JNICALL Java_com_spvessel_glfwwrapper_GlfwWrapper_SetCursor(JNIEnv *env, jobject sender, jlong window, jlong cursor)
{
    glfwSetCursor((GLFWwindow *)window, (GLFWcursor *)cursor);
}

JNIEXPORT jdoubleArray JNICALL Java_com_spvessel_glfwwrapper_GlfwWrapper_GetCursorPos(JNIEnv *env, jobject sender, jlong window)
{
    double x, y;
