...
namespace SpaceVIL.Decorations
{
    ...
    public class Style
    {
        ...
        public static Style GetContextMenuStyle()
        {
            ...
            style.IsVisible = false;
            style.SetShadow(new Shadow(10, new Position(3, 3), Color.FromArgb(180, 0, 0, 0)));
        ...
        public static Style GetPopUpMessageStyle()
        {
            ...
            style.SetShadow(new Shadow(10, new Position(3, 3), Color.FromArgb(140, 0, 0, 0)));
            style.AddItemState(ItemStateType.Hovered, new ItemState()
            {
        ...
        public static Style GetTitleBarStyle()
        {
            ...
            maximizeStyle.Border.SetColor(Color.FromArgb(255, 100, 100, 100));
            ...
            hovered.Border.SetColor(Color.FromArgb(255, 84, 124, 94));
        ...
        public static Style GetDialogItemStyle()
        {
            ...
            windowStyle.SetShadow(new Shadow(5, new Position(3, 3), Color.FromArgb(180, 0, 0, 0)));
        ...
        public static Style GetMessageItemStyle()
        {
            ...
            okStyle.SetShadow(new Shadow(5, new Position(2, 2), Color.FromArgb(120, 0, 0, 0)));
        ...
        public static Style GetOpenEntryDialogStyle()
        {
            ...
            toolbarbuttonStyle.AddItemState(ItemStateType.Hovered, new ItemState(Color.FromArgb(40, 255, 255, 255)));
            ...
            buttonhiddenStyle.AddItemState(ItemStateType.Hovered, new ItemState(Color.FromArgb(40, 255, 255, 255)));
            ...
            okbuttonStyle.SetShadow(new Shadow(5, new Position(2, 2), Color.FromArgb(180, 0, 0, 0)));
            ...
            cancelbuttonStyle.SetShadow(new Shadow(5, new Position(2, 2), Color.FromArgb(180, 0, 0, 0)));
            ...
            filterStyle.AddItemState(ItemStateType.Hovered, new ItemState(Color.FromArgb(40, 255, 255, 255)));
            filterStyle.AddItemState(ItemStateType.Pressed, new ItemState(Color.FromArgb(30, 255, 255, 255)));
        ...
        public static Style GetInputDialogStyle()
        {
            ...
            btnStyle.SetShadow(new Shadow(5, new Position(2, 2), Color.FromArgb(120, 0, 0, 0)));
        ...
        public static Style GetSideAreaStyle()
        {
            ...
            windowStyle.SetShadow(new Shadow(10, new Position(), new Core.Size(30, 30), Color.White));
            style.AddInnerStyle("window", windowStyle);
